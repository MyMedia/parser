 ...
 */
class Twig_TokenParser_Stopwatch extends \Twig_TokenParser
{
    ...
    public function parse(\Twig_Token $token)
    {
        ...
        if ($this->stopwatchIsAvailable) {
            return new Twig_Node_Stopwatch($name, $body, new \Twig_Node_Expression_AssignName($this->parser->getVarName(), $token->getLine()), $lineno, $this->getTag());
        }
